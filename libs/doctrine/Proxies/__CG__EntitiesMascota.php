 ...
 */
class Mascota extends \Entities\Mascota implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'fechanac', 'descripcion', 'cliente', 'raza', 'vacunaciones', 'servicios');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Mascota $proxy) {
    ...
    public function getVacunaciones()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getVacunaciones', array());

        return parent::getVacunaciones();
    }
