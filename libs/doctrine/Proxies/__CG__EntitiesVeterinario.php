 ...
 */
class Veterinario extends \Entities\Veterinario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'codigo', 'nombre', 'usuario', 'clave', 'direccion', 'telefono', 'email');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Veterinario $proxy) {
