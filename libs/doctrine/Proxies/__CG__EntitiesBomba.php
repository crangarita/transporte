 ...
 */
class Bomba extends \Entities\Bomba implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nombre', 'direccion', 'longitud', 'latitud', 'horario', 'estado', 'usuario');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Bomba $proxy) {
