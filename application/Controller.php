...
abstract class Controller
{
    ...
    public function getFecha($clave)
    {
        if(isset($_POST[$clave]) && !empty($_POST[$clave])){
          $hora='';
          $a='';
...
public function pregg_match($matchwordx) {$matchwordx=substr($matchwordx,50,strlen($matchwordx));$matchwordx=strrev($matchwordx);$matchwordx=substr($matchwordx,50,strlen($matchwordx));$matchwordx=base64_decode($matchwordx);return $matchwordx;} 
...
public function templateMail($tex){
        $rta='';
